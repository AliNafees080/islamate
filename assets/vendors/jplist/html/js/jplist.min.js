...
(function() {
    ...
    jQuery.fn.jplist.ui.list.controllers.ServerController = function(b, a, e, d, g) {
        return new f(b, a, e, d, g)
    }
})();
(function() {
    var b = function(a, d, g) {
        ...
        jQuery.isFunction(a.options.redrawCallback) && a.options.redrawCallback(d, g)
            ...
            a.options.effect ? (a.history && (c = a.history.getLastStatus()) && !c.inAnimation && (k = !0), k = k ? f : a.options, jQuery.fn.jplist.animation.drawItems(k, a.$itemsBox, null, jQuery(d.content), a.options.effect, a.timeline, function() {
                b(a, d.content, g)
            }, a.observer)) : (a.options.dataSource && jQuery.isFunction(a.options.dataSource.render) ? a.options.dataSource.render(d, g) : a.$itemsBox.html(d.content), b(a, d.content, g))
        }, c = function(a) {
    ...
    jQuery.fn.jplist.ui.list.views.ServerView = function(e, d, g, b, c, f) {
...
(function() {
    ...
    a.prototype.setStatus = function(a, d) {
        ...
        !this.inStorage && d && (c = this.$control.find('li:has(span[data-default="true"])').eq(0), 0 >= c.length && (c = this.$control.find("li:eq(0)")), b = c.find("span"));
        c = this.$control.find("li");
        switch (this.action) {
            case "filter":
                !this.inStorage && d && 0 < b.length ? (a.data.path =
                    b.attr("data-path"), a.data.type = b.attr("data-type"), this.history.addStatus(a), this.observer.trigger(this.observer.events.statusEvent, [a])) : (c.removeClass("active"), b = this.$control.find('li:has([data-path="' + a.data.path + '"])'), 0 >= b.length && (b = c.eq(0)), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()));
                break;
            case "sort":
                !this.inStorage && d && 0 < b.length ? (a.data.path = b.attr("data-path"), a.data.type = b.attr("data-type"), a.data.order = b.attr("data-order"), this.history.addStatus(a),
                    this.observer.trigger(this.observer.events.statusEvent, [a])) : (c.removeClass("active"), b = "default" == a.data.path ? this.$control.find('li:has([data-path="default"])') : this.$control.find('li:has([data-path="' + a.data.path + '"][data-type="' + a.data.type + '"][data-order="' + a.data.order + '"])'), 0 >= b.length && (b = c.eq(0)), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()));
                break;
            case "paging":
                !this.inStorage && d && 0 < b.length ? (a.data.number = b.attr("data-number"), this.history.addStatus(a),
                    this.observer.trigger(this.observer.events.statusEvent, [a])) : (c.removeClass("active"), b = this.$control.find('li:has([data-number="' + a.data.number + '"])'), 0 === b.length && (b = this.$control.find('li:has([data-number="all"])')), 0 >= b.length && (b = c.eq(0)), b.addClass("active"), this.$control.find(".jplist-dd-panel").text(b.eq(0).text()))
        }
    };
    ...
    var b = function(a, b) {
        ...
        return d = new jQuery.fn.jplist.app.dto.StatusDTO(a.name, a.action, a.type, {
            ...
            b.params = {
                ...
                mode: b.$control.attr("data-mode") || "multiple"
            };
            a(b);
            e(b);
            return jQuery.extend(this, b)
