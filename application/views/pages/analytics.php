<div id="wrapper">
    ...
    <input type="hidden" value="analytics/delete_comment" id="js_delete_comment"/>
    <input type="hidden" value="analytics/insert_comment" id="js_insert_comment"/>
                    ...
                    <div class="col-md-12">
                        <div class="portlet box">
                            <div class="portlet-header prolet-primary">
                                <div class="caption text-uppercase"> <i style="font-size: 17px; margin-top: 2px; color:#ffffff;" class="fa fa-list-alt"></i>Latest Contents</div>
                                <div class="tools"><i class="fa fa-chevron-up"></i>
                                </div>
                            </div>
                            <div style="overflow: hidden;" class="portlet-body">
                                <ul class="list-group">
                                <?php                                
                                foreach($content as $value){ //print_r($value); die(); ?>
                                    <li class="list-group-item">
                                        <?php $extension = explode('.',$value['filepath']);
                                              $file = end($extension);?>
...
<!--                                            <i class="fa-picture-o fa "></i>-->
                                        ...
                                        <span class="contents-name" style=" width: 50%; overflow: hidden; display: inline-block;"><?php if(!$value['name'] == "") { echo $value['name'];} else echo ""; ?></span>
                                ...
                                <?php } ?>
                                        <!--<span class="contents-user pull-right" data-target="#modal-show-content" data-toggle="modal" style=" width: 14%; overflow: hidden;"><?php echo $value['type']; ?></span>-->
                                        ...
                                        if($value['user_name'] != "")
                                            ...
                                            echo "&nbsp;";
                                        ?></span>
                                        <span class="contents-date pull-right" style=" width: 18%; overflow: hidden;"><?php echo date('d F Y H:i:s',  strtotime($value['activity_time'])); ?></span>
                                    </li>                                    
                                <?php } ?>
...
<!--                                                    <img src="<?php echo $thumbnail; ?>" class="" style=" float: left; width: 75px;"/>-->
...
<script>
   ...
   // console.log(allcomments); 
    ...
    $('#basic-bar-chart').highcharts({
        ...
        var document = <?php echo $filevalue; ?>;
        var Audio = <?php echo $audiovalue; ?>;
        var image = <?php echo $imagevalue; ?>;
        var Video = <?php echo $videovalue; ?>;
     ...
     $('#piegraph').highcharts({
        ...
        colors: ['#20b889', '#f2f2f2','#1b9d75', '#70737a'],
        title: {
            text: ''
        },
        tooltip: {
