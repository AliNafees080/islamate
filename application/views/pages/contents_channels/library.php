...
//                echo '</pre>';
    ...
    <!--                                            <li><span data-path=".desc" data-order="asc" data-type="text">Description A-Z</span>
                                    ...
                                    <div class="" style="display: inline-block;float: right">
                                        <!--filepicker-->
                                        <input onchange="filepickerresponse(event.fpfiles)" data-fp-button-class="btn btn-grey fa fa-upload" data-fp-multiple="true"  data-fp-button-text=" " data-fp-store-path="" data-fp-mimetypes="*/*" data-fp-apikey="Ayr6iaQ5lSSiU6LJjOlNvz" type="filepicker">
                                        <!--filepicker-->
...
//                            $("[name='"+key+"']").val(value);
            ...
            function filepickerresponse (response){ // console.log("entered");
                ...
                var  uploadedfile =  $.ajax({
                    ...
                    async: false,
                    success:function(){
                        filepicker.setKey("Ayr6iaQ5lSSiU6LJjOlNvz");                              
                        filepicker.remove(
                        file.url,
                        function(){
                            console.log("Removed");
